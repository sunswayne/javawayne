...
更多一点的，可能会提到HashMap不是线程安全的，而HashTable是；HashMap允许key和value为null；HashMap可以通过调用「[失控](https://zh.wikipedia.org/wiki/%E5%A4%B1%E6%8E%A7)」获得对应的Set集合实现Map的遍历操作，如下面代码所示：
